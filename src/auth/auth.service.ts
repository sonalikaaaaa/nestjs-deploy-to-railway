...
//we are injecting the services we are gonna use here in this....we didnt import config module because it is set to global in app module
@Injectable()
export class AuthService {
  ...
  > {
    ...
    if (!user.password) {
      throw new UnauthorizedException('Invalid user: password not found');
    }
